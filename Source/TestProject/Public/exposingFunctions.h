...
#include "exposingFunctions.generated.h"

UCLASS()
class TESTPROJECT_API AexposingFunctions : public AActor
{
	GENERATED_BODY()
...
protected:
	...
	//making a function callable in BP that's value in the parameter can be changed.
